...
export default function Account() {
    const { user, setUser, setLoader, mode, setOpen, setSnackbarMsg } = useContext(GeneralContext);
    ...
    const handleSubmit = ev => {
        ...
        fetch(`https://api.shipap.co.il/clients/update?token=235796e8-56e7-11ee-aae9-14dda9d4a5f0`, {
            credentials: 'include',
            method: 'PUT',
                ...
                user ?
                    <Container component="main" maxWidth="xs">
                        ...
                        >
                            ...
                            <Typography component="h1" variant="h5">Edit User Details</Typography>
